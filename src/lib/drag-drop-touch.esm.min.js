  ...
  d = class {
    ...
    _touchmove(t) {
      ...
      if (this._shouldHandleMove(t) || this._shouldHandlePressHoldMove(t)) {
        ...
        if (
          ...
          e !== this._lastTarget &&
            (this._lastTarget && this._dispatchEvent(this._lastTouch, "dragleave", this._lastTarget),
    ...
    _touchend(t) {
      ...
      if (this._shouldHandle(t)) {
        ...
        this._img || ((this._dragSource = null), this._dispatchEvent(this._lastTouch, "click", t.target)),
          this._destroyImage(),
          this._dragSource &&
