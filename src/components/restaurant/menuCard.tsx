...
import { FoodItemProps } from "./restaurant";
...
export function MenuCard({ foodId, foodName, foodPhoto, foodPrice, isDeleting, setFoods, controls, i }: MenuCardProps) {
  return (
    <>
      <motion.div
...
export function MenuCardDummy({
  ...
  foodPhoto,
  foodPrice,
}: Omit<MenuCardProps, "foodId" | "controls" | "setFoods" | "isDeleting" | "i">) {
  return (
