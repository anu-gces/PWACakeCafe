...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn("mt-2 outline-offset-2 focus-visible:outline  focus-visible:outline-ring/70", className)}
    {...props}
  />
));
...
export {
  Tabs as OriginTabs,
  TabsContent as OriginTabsContent,
  TabsList as OriginTabsList,
  TabsTrigger as OriginTabsTrigger,
};
