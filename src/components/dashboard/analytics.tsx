...
import { groupDataByYear } from "./analytics.utils";
  ...
  return (
    <ResponsiveContainer width="100%" height={400}>
      <LineChart data={data}>
        ...
        <Line type="linear" dataKey="income" stroke="#16a34a" activeDot={{ r: 8 }} dot={true} />
        <Line type="linear" dataKey="expenditure" stroke="#e11d48" activeDot={{ r: 8 }} dot={true} />
      </LineChart>
    </ResponsiveContainer>
  );
}
    ...
    <ResponsiveContainer width="100%" height={400}>
      <AreaChart data={data}>
        ...
        <Area
          ...
          activeDot={{ r: 8 }}
        />
        <Line type="natural" dataKey="income" stroke="#10B981" isAnimationActive={true} />
...
function AnalyticsPieChart() {
  return (
    <ResponsiveContainer width="100%" height={400}>
      <PieChart>
        <Pie dataKey="value" data={pieData} cx="50%" cy="50%" outerRadius={110} innerRadius={75} fill="#8884d8" label>
          {pieData.map((_, index) => (
...
export function Analytics() {
  ...
  const { data: yearlyData, isLoading } = useQuery<RevenueData[], Error>({
    queryKey: ["yearlyData"],
    queryFn: () => groupDataByYear(mockDataSample5),
  });
  ...
  return (
    <>
      <div className="gap-4 grid md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row justify-between items-center space-y-0 pb-2">
            <CardTitle className="font-medium text-sm">Total Expenditure</CardTitle>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <Card>
          <CardHeader className="flex flex-row justify-between items-center space-y-0 pb-2">
            <CardTitle className="font-medium text-sm">Average Check Size</CardTitle>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <Card>
          <CardHeader className="flex flex-row justify-between items-center space-y-0 pb-2">
            <CardTitle className="font-medium text-sm">Gross Profit Margin</CardTitle>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
      ...
      <div className="gap-4 grid md:grid-cols-2 lg:grid-cols-7 h-full">
        <Card className="col-span-4 h-full">
          <Tabs defaultValue="line" className="flex flex-col h-full">
            <CardHeader>
              ...
              {isLoading ? (
                ...
                <>
                  <TabsContent value="line">
                    <AnalyticsLineChart data={yearlyData!} />
                  </TabsContent>
                  <TabsContent value="area">
                    <AnalyticsAreaChart data={yearlyData!} />
                  </TabsContent>
                </>
              )}
            </CardContent>
        ...
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>Percentage of sales by menu category.</CardDescription>
          </CardHeader>
          <CardContent>
            <AnalyticsPieChart />
          </CardContent>
