  ...
  return (
    <div className="flex flex-col items-center gap-2 h-full">
      <div className="flex flex-row justify-center gap-2 w-full">
        ...
        />
        <CustomCard title="Title 2" description="Description 2" content="Content 2" footer="Footer 2" />
        <CustomCard title="Title 3" description="Description 3" content="Content 3" footer="Footer 3" />
        <CustomCard title="Title 4" description="Description 4" content="Content 4" footer="Footer 4" />
      </div>
